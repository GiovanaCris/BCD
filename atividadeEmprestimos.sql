...
-- LEFT JOIN: Mostragem dos nomes de todos os autores e os títulos de seus livros, incluindo autores que não tenham livros cadastrados
SELECT autores.nome_autor, livros.titulo
FROM autores
LEFT JOIN livros ON livros.id_livro = autores.id_livro;